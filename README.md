local placeId = game.PlaceId
	...
	if placeId == 2753915549 then --- Blox Fruit Old
		...
		if game.CoreGui:FindFirstChild("Satang X HUB") then
			game.CoreGui:FindFirstChild("Satang X HUB"):Destroy()
		end
...
do
	...
	if placeId == 189707 then --- Natural Disaster Survival
		...
		S9s04:addButton("Copy Link Discord",function()
			...
			setclipboard("https://discord.gg/Sc7Bkdpw")
		end)

		S9s04:addButton("Credit",function()

			L9s0:Notify("CREDIT ", "Satang X HUB")
			wait(2.5)
			L9s0:Notify("CREDIT ", "Buy Script Satang X Hub Hub")
		end)
